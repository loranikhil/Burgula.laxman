    ...
    <header className={`portfolio-header ${isScrolled ? 'scrolled' : ''}`}>
      <div className="header-container">
        ...
        >
          ...
          <span className="logo-text">Burgula Laxman</span>
        </div>
        ...
        <nav className="header-navigation desktop-nav">
          ...
          <a href="#Videos" className="nav-link" onClick={handleNavClick}>Videos</a>
        </nav>

        {/* Desktop Contact */}
        <div className="header-contact desktop-contact">
          <Phone className="contact-icon" />
          <span className="contact-text">+91 9951155742</span>
        </div>
